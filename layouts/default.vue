...
      <header>
        ...
        <div class="sui-navbar"> 
            ...
            <div class="sui-nav pull-right info" v-if="user.name!==undefined"> 
             ...
             <li><a href="/manager"  class="homego"> <!-- <img :src="user.avatar" width="50px" height="50px" :alt="user.name" />  --><img src="~/assets/img/widget-photo.png" width="50px" height="50px" :alt="user.name" /></a></li>
            </div> 
             <div class="sui-nav pull-right info"  v-if="user.name===undefined"> 
